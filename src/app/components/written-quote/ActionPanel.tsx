      ...
      {role === 'HOMEOWNER' ? (
        <div className="flex items-end gap-2">
          <div className="flex-1">
            ...
            <input
              ...
              type="number"
              className="neu-input w-full bg-background text-foreground shadow-neu-inset border border-border rounded-lg px-3 py-2"
              value={amount}
          ...
          <button
            className="neu-btn-primary px-4 py-2 rounded-lg shadow-neu-outset"
            disabled={disabled}
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-2">
          ...
          <div className="flex gap-2">
            <button
              className="neu-btn-secondary px-4 py-2 rounded-lg shadow-neu-outset"
              disabled={disabled}
