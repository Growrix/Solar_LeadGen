...
export async function GET(
  ...
  try {
    ...
    console.error('❌ [GET /api/admin/blog/categories/[id]] Error:', error);
...
export async function PATCH(
  ...
  try {
    ...
    console.error('❌ [PATCH /api/admin/blog/categories/[id]] Error:', error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error('❌ [DELETE /api/admin/blog/categories/[id]] Error:', error);
