  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="flex items-start justify-between gap-4 mb-8">
        <div>
          <h1 className="text-heading-1 text-foreground mb-2">Blog Categories</h1>
          <p className="text-heading-4 text-muted-foreground">Category management is coming next.</p>
        </div>
