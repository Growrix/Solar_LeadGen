            ...
            <div className="mt-12 pt-8 border-t border-border">
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <button
                  ...
                  className="h-10 w-10 flex items-center justify-center rounded-full border border-border text-muted-foreground hover:bg-surface hover:text-foreground transition-colors"
                >
                  <LinkIcon />
                </button>
              </div>
