...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = "inline-flex items-center justify-center transition duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 disabled:opacity-50 disabled:cursor-not-allowed tracking-wide relative";
  ...
  const variants = {
    ...
    link: "bg-transparent text-accent hover:text-accent p-0 h-auto hover:underline underline-offset-4 shadow-none focus:ring-0 focus:ring-offset-0 border-none",
