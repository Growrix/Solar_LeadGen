  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <button
        ...
        disabled={disabled}
        className={`relative h-7 w-12 rounded-full transition-colors duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background${checked ? ' bg-accent' : ' bg-surface'}
