    ...
    <div className={`flex items-start gap-3${className}`}>
      <div className="relative flex items-center">
        <input
          type="checkbox"
          id={id}
          className="peer h-5 w-5 appearance-none rounded border border-border bg-background/50 checked:bg-accent checked:border-accent focus:outline-none focus:ring-2 focus:ring-accent/50 focus:ring-offset-2 focus:ring-offset-slate-900 transition cursor-pointer disabled:cursor-not-allowed disabled:opacity-50"
          {...props}
        />
