  ...
  return (
        <Section className="py-24 bg-background border-t border-border relative overflow-hidden" containerClassName="relative z-10">
            <div className="bg-gradient-to-br from-accent to-accent rounded-3xl p-8 md:p-16 text-center shadow-2xl relative overflow-hidden ring-1 ring-border/10">
                ...
                <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 rounded-full bg-accent/40 blur-3xl" />
                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                    <div className="max-w-xl">
                        ...
                        <Text variant="brand" className="text-accent text-body-large">
                            {NEWSLETTER_CONTENT.subheadline}
                        </Text>
                        
                        <div className="mt-8 flex flex-col sm:flex-row gap-4 items-center justify-center lg:justify-start text-accent text-body-small">
                            {NEWSLETTER_CONTENT.features.map((feature, idx) => (
                                <div key={idx} className="flex items-center gap-2">
                                    <CheckCircle2 className="w-4 h-4 text-foreground-secondary" />
                                    <span>{feature}</span>
                                </div>
                            ))}
                        </div>
                    ...
                    <GlassSurface className="w-full max-w-md p-6 rounded-2xl border shadow-inner">
                        <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <p className="text-center text-accent mt-2 opacity-80 text-caption">
