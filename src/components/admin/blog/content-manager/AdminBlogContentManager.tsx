...
import PostsPanel from '@/components/admin/blog/content-manager/PostsPanel';
import CategoriesPanel from '@/components/admin/blog/content-manager/CategoriesPanel';
import TagsPanel from '@/components/admin/blog/content-manager/TagsPanel';
...
export default function AdminBlogContentManager() {
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="flex items-start justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-heading-4 text-muted-foreground">Posts, categories, and tags in one place.</p>
        </div>
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <div className="text-body-small text-muted-foreground">
              Mirrors the prototype structure; tokenization and polish comes after.
            </div>
          </div>
      ...
      {activeTab === 'posts' ? <PostsPanel /> : null}
      {activeTab === 'categories' ? <CategoriesPanel /> : null}
      {activeTab === 'tags' ? <TagsPanel /> : null}
