...
export default function TagList() {
  ...
  return (
    <div className="bg-surface rounded-2xl shadow-neu-outset p-6">
                      ...
                      <div className="flex justify-end gap-3">
                        {isEditing ? (
                          ...
                          <>
                            ...
                            <Button variant="secondary" className="px-4 py-2" disabled={busy} onClick={() => void handleDelete(tag.id)}>
                              Delete
                            </Button>
                          </>
                        )}
      ...
      <div className="mt-4 text-body-small text-muted-foreground">Note: this is live-wired to your existing Tags API.</div>
    </div>
  );
}
