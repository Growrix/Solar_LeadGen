      ...
      <div className="bg-surface rounded-2xl shadow-neu-outset overflow-hidden">
        {error ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-muted-foreground mt-2">Create your first draft to see it here.</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="min-w-full">
              ...
              <tbody>
                {posts.map((post) => (
                  <tr key={post.id} className="group border-t border-border hover:bg-surface-hover transition-colors">
                    <td className="px-6 py-4">
                      <button type="button" onClick={() => router.push(`/admin/blog/${post.id}`)} className="text-left">
                      ...
                      <div className="mt-2 text-body-small text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity">
                        <button type="button" onClick={() => router.push(`/admin/blog/${post.id}`)} className="hover:text-foreground">
                          Edit
                        </button>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex justify-end gap-3">
                        <Button variant="secondary" className="px-4 py-2" onClick={() => router.push(`/admin/blog/${post.id}`)}>
                          Edit
                        </Button>
                        <Button variant="secondary" className="px-4 py-2" onClick={() => router.push(`/admin/blog/${post.id}/preview`)}>
                          Preview
                        </Button>
                      </div>
                    </td>
