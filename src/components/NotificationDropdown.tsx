  ...
  return (
    <div ref={dropdownRef} className={`relative ${className || ''}`}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute top-0 right-0 flex h-4 w-4 items-center justify-center rounded-full bg-accent text-caption font-caption-semibold text-white ring-2 ring-surface">
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-border p-4 bg-surface">
            <h3 className="text-heading-2 font-heading-semibold text-foreground">
              Notifications
            </h3>
            {unreadCount > 0 && (
              <button
                onClick={markAllAsRead}
                className="flex items-center gap-1.5 text-body-small text-primary hover:text-primary-hover transition-colors font-body-medium"
              ...
              <div className="divide-y divide-border">
                {notifications.map((notification) => (
                  <NotificationCard
                    ...
                    getCategory={getNotificationCategory}
                    getIconClasses={getIconContainerClasses}
          ...
          {notifications.length > 0 && (
            <div className="border-t border-border p-3 bg-surface">
              <button
                ...
                className="w-full text-center text-body-small text-primary hover:text-primary-hover font-body-semibold transition-colors"
...
interface NotificationCardProps {
  ...
  getCategory: (type: string) => 'success' | 'error' | 'info' | 'accent';
  getIconClasses: (category: 'success' | 'error' | 'info' | 'accent') => string;
...
const NotificationCard: React.FC<NotificationCardProps> = ({
  ...
  const iconContainerClasses = getIconClasses(category);
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex justify-between items-start gap-2 mb-1">
              <h4 className="text-heading-3 font-heading-semibold text-foreground flex-1">
                {notification.title}
              </h4>
            ...
            <div className="flex gap-2">
                {!notification.isRead && (
                  <button
                    ...
                    className="px-3 py-1.5 text-caption font-caption-medium rounded-button border border-primary text-primary bg-transparent hover:bg-surface-hover transition-colors flex items-center gap-1.5 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-primary"
