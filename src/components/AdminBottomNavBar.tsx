...
const NavItem: React.FC<{ 
  ...
  <button 
    onClick={onClick} 
    className={`ui-bottom-nav__item ${isActive ? 'ui-bottom-nav__item--active' : ''}`}
  >
    <span className="ui-bottom-nav__icon">{icon}</span>
    <span className="ui-bottom-nav__label text-caption">{label}</span>
  </button>
);
...
const AdminBottomNavBar: React.FC<AdminBottomNavBarProps> = ({ 
  ...
  return (
    <div 
      className="ui-bottom-nav md:hidden"
    >
