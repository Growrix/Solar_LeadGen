...
export function Footer({ onBecomePartnerClick, onPartnerSignInClick, onScrollToQuote, onScrollToRebate, onBlogClick, onGovernmentNewsClick }: FooterProps) {
  return (
    <footer id="contact-section" className="border-t border-border mt-0 bg-background">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3"><Phone className="h-5 w-5 text-primary" /><span className="text-body text-muted-foreground">1300 SOLAR (76527)</span></div>
