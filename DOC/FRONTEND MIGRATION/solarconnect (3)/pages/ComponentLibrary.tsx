...
import { Phone, Zap, Mail, Plus, Search } from 'lucide-react';
...
export const ComponentLibrary: React.FC<ComponentLibraryProps> = ({ onNavigate, activePage }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 pt-24 pb-20">
      <Container>
        {/* Header */}
        <div className="mb-8">
          <Heading level={1} className="mb-4">{UI_LABELS.designSystem}</Heading>
          <Text size="lg">{UI_LABELS.docsSubtitle}</Text>
        </div>
