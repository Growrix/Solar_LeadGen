...
const DraftsPage: React.FC<DraftsPageProps> = ({ onReviewDraft }) => {
    ...
    <div className="h-full flex flex-col overflow-hidden animate-in fade-in duration-500">
      ...
      <div className="px-8 py-4 bg-white border-b border-slate-200 flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="bg-indigo-600 text-white px-4 py-1.5 rounded-lg text-sm font-black hover:bg-indigo-700 shadow-sm transition-all uppercase tracking-widest">
            Quick Draft
          </button>
        </div>
      </div>
