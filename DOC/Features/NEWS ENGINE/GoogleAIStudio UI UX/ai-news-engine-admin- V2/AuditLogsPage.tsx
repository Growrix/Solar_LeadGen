...
const AuditLogsPage: React.FC<AuditLogsPageProps> = ({ onViewPrompt }) => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setLogs([
        { 
          id: '1', 
          timestamp: '2023-10-24 14:20:01', 
          source: 'TechCrunch RSS', 
          origin: 'AI', 
          promptUsed: 'SYSTEM INSTRUCTION: You are a tech journalist. ROLE: Summarize breaking news about DeepSeek V3 architecture. REQUIREMENTS: Focus on MoE implementation and training efficiency breakthroughs. CONTEXT: Ingested 3 research papers and 2 news articles. OUTPUT: Draft Ready.', 
        ...
        { 
          ...
          origin: 'AI', 
          promptUsed: 'SYSTEM INSTRUCTION: You are a financial analyst. ROLE: Analyze volatility in Fed interest rate projections. REQUIREMENTS: Identify core sentiment shifts and major institutional predictions. OUTPUT: Research Complete.', 
        ...
        { 
          id: '4', 
          timestamp: '2023-10-24 11:15:00', 
          source: 'Reuters Business', 
          origin: 'AI', 
          promptUsed: 'SYSTEM INSTRUCTION: You are a business editor. ROLE: Generate 500-word business analysis on NVIDIA profits. REQUIREMENTS: Use quarterly earnings data, compare against Q3, and focus on datacenter segment growth. OUTPUT: Published.', 
          action: 'Published', 
          admin: 'Jane Smith', 
        ...
        { 
          id: '5', 
          timestamp: '2023-10-24 10:05:22', 
          source: 'System Overload', 
          origin: 'AI', 
          action: 'Token Limit Exceeded', 
          admin: 'System', 
