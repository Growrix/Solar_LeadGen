                  ...
                  <tr key={item.id} className="hover:bg-slate-50 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest flex items-center gap-1.5">
                        {item.sourceType === 'AI Agent' && <Cpu size={12} className="text-indigo-500" />}
                        {item.sourceType === 'RSS Feed' && <Rss size={12} className="text-emerald-500" />}
                        {item.sourceType === 'Manual Entry' && <Plus size={12} className="text-amber-500" />}
                        {item.sourceType}
                      </span>
                    </td>
