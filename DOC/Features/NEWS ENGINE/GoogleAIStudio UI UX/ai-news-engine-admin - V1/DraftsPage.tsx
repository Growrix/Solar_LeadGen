...
const DraftCard: React.FC<{ item: NewsItem; onClick: () => void }> = ({ item, onClick }) => (
  ...
  >
    ...
    <h4 className="text-sm font-semibold text-slate-900 leading-tight mb-2 group-hover:text-indigo-600 transition-colors">
      {item.title}
    </h4>
      ...
      setItems([
        {
          ...
          summary: 'Analysis of the MoE implementation and training efficiency breakthroughs...',
          status: NewsStatus.RESEARCH_DONE,
          category: 'AI Tech',
          relevanceScore: 98,
        ...
        },
        {
          ...
          summary: 'Market reaction to the latest datacenter revenue projections...',
        ...
        {
          id: '3',
          title: 'EU Launches New AI Sandbox for Startups',
          summary: 'The European Commission aims to foster innovation while ensuring safety...',
        ...
        {
          id: '4',
          title: 'SpaceX Successful Starship Flight 6',
          summary: 'Capture mechanism improvements demonstrated in latest orbital test...',
        ...
        {
          id: '5',
          title: 'Apple Vision Pro 2 Leaks Surface',
          summary: 'New supply chain reports suggest a more lightweight design focusing on...',
          status: NewsStatus.RESEARCH_DONE,
          category: 'Tech',
          relevanceScore: 84,
          aiModel: 'Gemini 3 Flash',
    ...
    <div className="h-full flex flex-col overflow-hidden animate-in fade-in duration-500">
      ...
      <div className="px-8 py-4 bg-white border-b border-slate-200 flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="bg-indigo-600 text-white px-4 py-1.5 rounded-lg text-sm font-semibold hover:bg-indigo-700 shadow-sm transition-all">
            Quick Draft
          </button>
        </div>
      </div>
          ...
          {columns.map((col) => {
            ...
            return (
              <div key={col.id} className="w-80 flex flex-col">
                ...
                <div className="flex-1 bg-slate-100/30 rounded-2xl p-2 border border-dashed border-slate-200 min-h-[500px]">
                  {isLoading ? (
                    <ColumnSkeleton />
...
const Plus: React.FC<{ size?: number }> = ({ size = 20 }) => (
