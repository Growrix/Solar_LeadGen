...
const TestPreviewModal: React.FC<TestPreviewModalProps> = ({ isOpen, onClose }) => {
                ...
                <div className="max-w-2xl mx-auto space-y-6">
                  <div className="space-y-2">
                    ...
                    <h4 className="text-2xl font-bold text-slate-900 leading-tight">
                      Next-Gen Silicon Photonics Breakthrough set to Revolutionize Data Centers
                    </h4>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="prose prose-sm font-serif text-slate-700 leading-relaxed text-lg">
                      <p>
                        In a landmark development for the semiconductor industry, researchers have unveiled a new silicon photonics architecture that achieves unprecedented data transmission speeds while reducing power consumption by over 40%...
                      </p>
                      <p>
