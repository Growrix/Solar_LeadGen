...
const SourceToggle: React.FC<{ active: boolean; onChange: () => void }> = ({ active, onChange }) => (
  <button 
    onClick={onChange}
...
const SourcesPage: React.FC<SourcesPageProps> = ({ onAddSource, onEditSource }) => {
                      ...
                      <tr key={source.id} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            <SourceToggle active={source.status === SourceStatus.ACTIVE} onChange={() => {}} />
                ...
                <div key={item.id} className="flex items-center gap-6 p-4 bg-slate-50 rounded-xl border border-slate-100">
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <SourceToggle active={true} onChange={() => {}} />
                    </div>
                    <div className="space-y-1">
                      ...
                      <input 
                        ...
                        onChange={(e) => setResearchWeights({...researchWeights, [item.id]: parseInt(e.target.value)})}
                      />
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4 space-y-4 border-t border-slate-100">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <SourceToggle active={false} onChange={() => {}} />
                </div>
              </div>

              <button className="w-full py-2.5 bg-slate-900 text-white rounded-lg font-bold text-sm hover:bg-slate-800 transition-all shadow-md active:scale-[0.98]">
                Save Configuration
              </button>
            </div>
          </section>
