    ...
    const timer = setTimeout(() => {
      setLogs([
        { 
          ...
          origin: 'AI', 
          promptUsed: 'Summarize breaking news about DeepSeek V3 architecture...', 
        ...
        { 
          ...
          origin: 'AI', 
          promptUsed: 'Analyze volatility in Fed interest rate projections...', 
        ...
        { 
          ...
          origin: 'AI', 
          promptUsed: 'Generate 500-word business analysis on NVIDIA profits...', 
          action: 'Published', 
          admin: 'Jane Smith', 
